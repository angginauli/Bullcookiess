...
class TentangDeveloper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val phoneBtn = findViewById<Button>(R.id.button)
        phoneBtn.setOnClickListener {
            val dialIntent = Intent(Intent.ACTION_DIAL)
            dialIntent.data = Uri.parse("tel:" + "08999349719")
        ...
        bmp = BitmapFactory.decodeResource(resources, R.drawable.tentang)
    ...
    fun generatePDF() {
        ...
        val desc: String = getString(R.string.biografi)
        ...
        canvas.drawText("Tentang Developer", 209F, 100F, title)
        canvas.drawText("Bullcookies", 209F, 80F, title)
        ...
        canvas.drawText("Biografi Developer", 396F, 560F, title)

        title.textAlign = Paint.Align.LEFT
        canvas.drawText(desc, 396F, 560F, title)
        ...
        val file: File = File(Environment.getExternalStorageDirectory(), "Tentang_Developer.pdf")
